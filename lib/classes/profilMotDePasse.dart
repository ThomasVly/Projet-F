...
class PMotDePassePage extends StatefulWidget {
  const PMotDePassePage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<PMotDePassePage> createState() => _PMotDePassePageState();
}

class _PMotDePassePageState extends State<PMotDePassePage> {
  ...
  void main() {
    runApp(MaterialApp(
      ...
      home: PMotDePassePage(title: 'MotDePasse'),
    ));
  }
}
